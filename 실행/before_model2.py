...
train_data = pd.read_csv('test_1.csv' ,encoding='CP949')
train_data2 = pd.read_csv('test_2.csv' ,encoding='CP949')
...
dataframe.to_csv('test_3.csv',header=False, index=False ,mode="w",encoding='euc-kr')

dataframe = pd.DataFrame(train_data2)
dataframe.to_csv('test_4.csv',header=False, index=False ,mode="w",encoding='euc-kr')
