...
train_data = pd.read_csv('data7.csv' ,encoding='CP949')
test_data = pd.read_csv('test10000.csv' ,encoding='CP949')
...
a1 = test_data['1'].tolist()
a2 = test_data['2'].tolist()
a3 = test_data['3'].tolist()
a4 = test_data['4'].tolist()
a5 = test_data['5'].tolist()
a6 = test_data['6'].tolist()
a7 = test_data['7'].tolist()
a8 = test_data['8'].tolist()
a9 = test_data['9'].tolist()
a10 = test_data['10'].tolist()
a11 = test_data['11'].tolist()
a12 = test_data['12'].tolist()
a13 = test_data['13'].tolist()
a14 = test_data['14'].tolist()
a15 = test_data['15'].tolist()
...
model.add(Dense(226, activation='softmax'))


es = EarlyStopping(monitor='val_loss', mode='min', verbose=1, patience=4)
mc = ModelCheckpoint('predict_model3.h5', monitor='val_acc', mode='max', verbose=1, save_best_only=True)

model.compile(loss='categorical_crossentropy', optimizer=Adam(learning_rate=1e-2), metrics=['acc'])
...
model.save('predict_model3.h5')
loaded_model = load_model('predict_model3.h5')
...
print('정확도(Accuracy) : ', sum(y_predicted == y_train) / len(y_train))
